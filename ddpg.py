...
print("ddpg device:" + device.type)

class DDPGAgent:
    def __init__(self, in_actor, hidden_in_actor, hidden_out_actor, out_actor, in_critic, hidden_in_critic, hidden_out_critic, lr_actor=1e-4, lr_critic=1e-3):
    ...
    def act(self, obs, noise=0.0):
        ...
        self.actor.eval()
        with torch.no_grad():
            N = noise*self.noise.noise()
#            print(N)
            action = self.actor(obs) + N
        self.actor.train()
        return action
